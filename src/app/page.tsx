...
// const MapVeiw = dynamic(()=> import('@/app/mapview'))
// export default function Home() {
//   return (
//       <main className="max-w-xl  py-10 px-4 ml-5 bg-black">
//         <div className="bg-white rounded-lg p-3">
//       <h1 className="text-3xl  text-pink-400 font-bold mb-6">Y2Z Travel Itinerary</h1>
//      <div className="flex justify-between items-center mb-6">
//   <p className="text-lg  text-gray-700 ml-5">Day</p>
//   <h1 className="text-2xl  font-bold  mr-50">itineary</h1>
// </div>
//       <ItineraryList />
//       </div>
//     </main>
...
export default function Home() {
  return (
    <main className="bg-black min-h-screen">
      {/* Mobile View: Only ItineraryList */}
